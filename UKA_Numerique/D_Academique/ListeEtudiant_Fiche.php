...
<div class="" style="display:none;" id="entete">
  ...
  <tr>
    ...
    <div class=" table-responsive"id="tableau">
            ...
            <table class="table">
                <tr>
                    <td> <span class="input-group-text">Année</span></td>
                    <td>
                        <select id="annee" class="form-select-lg mb-3">
                        <?php 
                    ...
                    <td>
                    <span class="input-group-text">Faculté </span>
                    </td>
                    <td>
                    <select class="form-select-lg mb-3" id="filiere" style="width:325px;" onchange="Selection_promo()" >
                    ...
                    <td>
                    <select class="form-select-lg mb-3" id="promotion" style="width:300px;" >
                        <option value="">Sélectionner</option>
                    </select>
                    </td>
                </tr>
      ...
      <div class="container " > 
        <div class="row "> 
            <div class="col-md-6" id="block1"style="height: 500px; overflow:auto;">
              <div class="card">
                <div class="card-header">
           

                  <table class="table table-bordered table-striped table-sm" id="tableListe">
                    <thead>
                      <tr>
                        <th>N°</th>
                        <th>Matricule</th>
            ...
            <div class="col-md-6" id="block8">
              <div class="card position-fixed"id="cursus">
                <div class="card-header">
                <table>
                <tr>
                  <td>
                  ...
                  <td>
                  <button id="btnAjuster"type="button"  class="btn btn-primary btn-effet" style="display:none" > Ajuster</button>
                  </td>
              </tr>
              </table> 
          ...
          <div class="col-md-12 "id="cursusImprimer"style="display:none">
            <div class="card ">
                ...
                <div class="card-header">
                  ...
                  <span id="datesigne" class="float-end"></span>
                  <br>
                  <span id="acad"class="float-end"></span><br><br>
                  <span id="academ"class="float-end fw-bold"></span>
                </div>
              </div>
          </div>
        </div>      
