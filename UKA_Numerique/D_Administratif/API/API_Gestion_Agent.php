        ...
        
        {
            ...
            if ($chaine == "fac") {
                ...
                $sql_insert = "INSERT INTO agent (Mat_agent, Nom_agent, Post_agent, Prenom, Sexe, 
                                                  ...
                                                  Tel, Date_Engagement, Niveau_Etude, Annee_Obt, Institution, Domaine, type_agent, Institution_attachee, Id_filiere) 
                               VALUES (:matricule, :nom, :postnom, :prenom, :sexe, 
                                       :lieu, :datenais, :grade, :etat, 
                                       :Idcategorie, :Adr, :mail, :tel, :dateEng, :niveau,
                                       :anneobt, :institution, :domaine, :type_agent, :institution_attache, :id_filiere)";
                ...
                $stmt->bindParam(':institution_attache', $institution_attache);
                $stmt->bindParam(':id_filiere', $id);
                $stmt->execute();
            }
            else
            {
