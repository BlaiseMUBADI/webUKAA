...
function AfficherListe_Base() {
    let tabBase = document.getElementById("TabBase");
    tabBase.classList.add("table", "table-bordered");
    while (tabBase.firstChild) {
        tabBase.removeChild(tabBase.firstChild);
    }
    ...
    tabBase.appendChild(thead);

    var tbody = document.createElement("tbody");

    var url = 'D_Administratif/API/API_Select_Agent_Avec_Base.php';
    fetch(url)
