...
document.addEventListener("DOMContentLoaded", function() {
    AfficherListePriméetBase();
});

function AfficherListePriméetBase() {
    let tabBaseEtPrime = document.getElementById("TabPrimeBase");
    tabBaseEtPrime.classList.add("table", "table-bordered");
    while (tabBaseEtPrime.firstChild) {
        tabBaseEtPrime.removeChild(tabBaseEtPrime.firstChild);
    }
    ...
    tabBaseEtPrime.appendChild(thead);

    var tbody = document.createElement("tbody");

    var url = 'D_Administratif/API/API_Select_Agent_Avec_Prime_et_Base.php';
    fetch(url)
    ...
    tabBaseEtPrime.appendChild(tbody);
}
