...
,CONCAT(etudiant.Nom,' ', etudiant.Postnom,' ',etudiant.Prenom) AS Nom_étudiant
,CONCAT(promotion.Abréviation,' ',mentions.Libelle_mention) as Prom
,ROUND(SUM(payer_frais.Montant_paie),2) as Montant
,frais.Montant as 'Argent_fixé'
,frais.Tranche as Tranche
...
and (payer_frais.Motif_paie='Enrôlement à la Mi-Session' || payer_frais.Motif_paie='Frais Académiques')

GROUP BY etudiant.Matricule,promotion.Abréviation,mentions.Libelle_mention
,frais.Tranche,frais.Montant,payer_frais.Motif_paie
order by Nom_étudiant";
