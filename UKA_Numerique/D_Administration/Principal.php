...
<?php
  ...
  <section data-bs-version="5.1" class="menu menu3 cid-sFAA5oUu2Y" once="menu" id="menu3-1" style="display:bloc">
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg "id="tete">
      <div class="container ">
  ...
  <div class="container " >
                ...
                <?php
                 ...
                 { 
                      ...
                      {
                        include("Liste_Paiement/Listepaie.php");
                      }
                      
                      elseif ($_GET['page']=="FicheEtudiant")
                      {
                        include("ListeEtudiant_Fiche.php");
                      }
                      else 
                      {
