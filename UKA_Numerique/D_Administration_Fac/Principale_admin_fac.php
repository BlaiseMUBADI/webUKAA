...
/*
      ...
      <?php
          ...
          require_once '../D_Generale/Menu_Gauche_Administration.php';
         
          if(@$_GET['page'])
          {
            
            if($_GET['page']=="gestion_user") require_once 'Entree_Par_Gestion_User.php';
            //if($_GET['page']=="compte_user") require_once 'Entree_Par_Gestion_User.php';
