...
<section class="home-section" style="height: 100%;">
  ...
  <div class="home-content m-0 me-3 ms-3 " id="div_gen_Aligne_Enseignant">
    ...
    <div class="rounded m-0 p-0 mb-2 text-center" style="color:white;background-color: #273746;">
      <div class="row p-2">
        ...
        <div class="col p-0 m-0 fw-medium ms-2 me-3">
          ...
          <div class="input-group mb-1 p-1 "style="color:white;">
            <label for="code_prom_Align_EC">Selection Promotion:</label>
    ...
    <div class="container text-center m-0 p-3 mt-1 border" 
      ...
      <div class="container p-0 m-0" style="width: 60%; float: left;height:100%;">


        <div class="container table-responsive small p-0 m-0" style="width: 100%; height:90%;">
        
          <table  class="tab1 table-bordered text-center" id="table_aligne_enseignant" style="width:100%;">              
        ...
        <div class="container p-0 m-0 mt-2">
          ...
          <div class="d-grid gap-1 p-0 m-0">
            <button id="btn_ajout_Enseignant" class="btn btn-primary p-0 m-0 font-weight-bold"
      ...
      <div class="container p-0 m-0" style="width: 38%; float:right; height:100%;">
        ...
        <div class="container p-0 m-0 mt-2">
          ...
          <div class="d-grid gap-1 p-0 m-0">
            <button id="btn_ajouC" class="btn btn-primary p-0 m-0 font-weight-bold"
                type="button" onclick="Ouvr()">Ajout
            </button>
          </div> 
        </div>
