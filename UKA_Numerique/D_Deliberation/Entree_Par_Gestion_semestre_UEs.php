...
<section class="home-section" style="height: 100%;">
  ...
  <div class="home-content me-3 ms-3"   id="div_gen_UE">
    ...
    <div class="container text-center m-0 p-3 mt-1 border" 
      ...
      <div class="container p-0 m-0" style="width: 45%; float: left;height:100%;">


        <div class="container table-responsive small p-0 m-0" style="width: 100%; height:90%;">
        
          <table  class="tab1 table-bordered text-center" id="table_semestre" style="width:100%;">              
        ...
        <div class="container p-0 m-0 mt-2">
          ...
          <div class="d-grid gap-1 p-0 m-0">
            <button id="btn_ajout_compte" class="btn btn-primary p-0 m-0 font-weight-bold"
                type="button" onclick="Nouveau_Semestre()">Ajouter un semestre
            </button>
          </div>
        </div>
      ...
      <div class="container p-0 m-0" style="width: 52%; float:right; height:100%;">


        <div class="container table-responsive small p-0 m-0" style="width: 100%;height:90%;">
          <table  class="tab1 table-hover table-striped" id="table_ues" style="width:100%; ">              
            <thead class="sticky-sm-top m-0 fw-bold ">
              <tr>
                <th>N°</th>
                <th>Code UE</th>
...
<dialog id="boite_Form_UE" 
  ...
  <div class="container border">
    <div class="modal-header">
      ...
      <button type="button" class="close ms-3" onclick="Ajout_UE()">
