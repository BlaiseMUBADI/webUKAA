    ...
    <div class="row ">
        <div class="col-md-12 ">
            <div class="mon_bloc bg-light">
               <button type="buttom" id="option1" class="btn btn-primary btn-effet" onclick="option1()"> Encodage des données</button>

               <button type="buttom" id="option2" class="btn btn-primary btn-effet" onclick="option2()"> Changement Mention (option) </button>

               <button type="buttom" id="option3" class="btn btn-primary btn-effet" onclick="option3()">Confirmation Etudiants et listes définitives</button>

               <button type="buttom" id="option'" class="btn btn-primary btn-effet" onclick="option4()"> Quitter l'application</button>
            ...
            <div class="mon_bloc">
                ...
                <label>Année Académique : </label>
                    <select id="annee">
                        ...
                        $reponse = $bdd->query ('SELECT * FROM annee_academique order by Annee_debut desc' );
                ...
                <select size="" id="faculte" style="width:160px;" onchange="updateTextBox1()" >
                    ...
                    $reponse = $bdd->query ('SELECT * FROM filiere order by IdFiliere' );
                    while ($ligne = $reponse->fetch()) {?>
...
<script src="js/affichage_donnee.js"></script> 
<script src="js/autre_fonctions_encodage.js"></script> 
<script src="js/affectation_etudiant.js"></script> 
