...
function fonction_imprimer_recu() {
  ...
  document.getElementById("montantrecu").innerText=document.getElementById("montantàinserer").value; 
  if(document.getElementById("montantàinserer").value=="0")
  {document.getElementById("Sommelettre").innerText="Zéro dollar";}
  else if(document.getElementById("montantàinserer").value=="10")
  {document.getElementById("Sommelettre").innerText="Dix dollars";}
  else if(document.getElementById("montantàinserer").value=="20")
  {document.getElementById("Sommelettre").innerText="Vingt dollars";}
  else if(document.getElementById("montantàinserer").value=="100")
  {document.getElementById("Sommelettre").innerText="Cent dollars";}
  
  
  document.getElementById("nomagentrecu").innerText=nomAgent;
}
function fonction_re_imprimer_recu() {
  const date=document.getElementById("datepaie");
  document.getElementById("daterecu").innerText=date.value;
  const nom_etudiant=document.getElementById("Nom").value+" "+document.getElementById("Postnom").value
  +" "+document.getElementById("Prenom").value;
...
var fenetreImpression = window.open('', '', 'height=600,width=800');
fenetreImpression.document.write('<html><head><title>Impression Rapport de Paie</title>');
// Ajout des styles pour la marge et le mode portrait
fenetreImpression.document.write('<style>@media print { @page { size: A4 portrait; } body { margin-top: 70px; } }</style>');
fenetreImpression.document.write('</head><body >');
fenetreImpression.document.write(contenu);
fenetreImpression.document.write('</body></html>');
fenetreImpression.document.close();
  ...
  <div class="home-content me-3 ms-3"  >
    ...
    <div class="sales-boxes m-0 p-3 mt-3 border" 
      ...
      <div class="bloc2 shadow-lg bg-body-tertiary rounded border m-0 p-3 m-0" 
        ...
        <center><h5  id="nom_Candidat"class="text border"sytle="width:100%;"></h5> </center> 
        

        <button type="submit" id="ReinprimerRecu" class="btn btn-primary mb-3"style="font-family:Palatino Linotype;"onclick="fonction_re_imprimer_recu()">Réimprimer reçu</button>
