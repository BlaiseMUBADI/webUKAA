    ...
    <div class="sales-boxes m-0 p-0 " >
      ...
      <div class="recent-sales box" style=" width:50%; margin:0px; ">    
        ...
        <div class="mb-3 row">
          ...
          <div class="mb-3 row">
          <label class="col-sm-2 col-form-label" id="montant" style="color: white;">.</label>
          <label class="col-sm-2 col-form-label" id="idfrais" hidden style="color: white;">.</label>
          <label class="col-sm-2 col-form-label" id="montantàinserer" hidden style="color: white;">.</label>
