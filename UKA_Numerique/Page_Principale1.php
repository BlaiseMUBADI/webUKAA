...
/*
      ...
      <?php
          ...
          <div style="display:bloc " id="menugauche"> <?php 
              ...
              else{ require_once 'D_Generale/Menu_Gauche_Perception.php'; }
               ?>
          </div>
          ...
          if(@$_GET['page'])
          {
            ...
            else if($_GET['page']=="ListeTous")require_once 'D_Administratif/Liste_tout_le_personnel.php';
  ...
  <script type="text/javascript" src="D_Administratif/js/Liste_Complète.js"></script>
