...
<div class="corps" style="text-align: center;">
			<div class="liens" style="">
				<div class="bouton" style="position: relative; display: inline-block; width: 150px; margin: 2px;"><a href="horaire.php?page=Médecine">Médecine</a></div>
				<div class="bouton" style="position: relative; display: inline-block; width: 150px; margin: 2px;" ><a href="horaire.php?page=Informatique">Informatique</a></div>
				<div class="bouton" style="position: relative; display: inline-block; width: 150px; margin: 2px;" ><a href="horaire.php?page=Droit">Droit</a></div>
				<div class="bouton" style="position: relative; display: inline-block; width: 150px; margin: 2px;"><a href="horaire.php?page=Economie">Economie</a></div>
				<div class="bouton" style="position: relative; display: inline-block; width: 150px; margin: 2px;"><a href="horaire.php?page=Architecture">Architecture</a></div>
				<div class="bouton" style="position: relative; display: inline-block; width: 150px; margin: 2px;"><a href="horaire.php?page=Communication">Communication</a></div>
				<div class="bouton" style="position: relative; display: inline-block; width: 150px; margin: 2px;"><a href="horaire.php?page=Communication">Polytechnique</a></div>
			</div>
