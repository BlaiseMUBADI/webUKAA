<div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
        ...
        <li class="nav-item"><a class="nav-link link text-primary display-7" href="https://uka.ac.cd/"><span class="mobi-mbri mobi-mbri-globe-2 mbr-iconfont mbr-iconfont-btn"></span>Site UKA</a></li>
		...
		<li class="nav-item"><a class="nav-link link text-primary display-7" href="horaire.php"><span class="mobi-mbri mobi-mbri-calendar mbr-iconfont mbr-iconfont-btn"></span>Les Horaires&nbsp;</a></li></ul>
