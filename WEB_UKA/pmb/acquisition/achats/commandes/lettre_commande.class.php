...
// +-------------------------------------------------+
// $Id: lettre_commande.class.php,v 1.1.2.1 2012-01-12 11:06:50 dgoron Exp $
...
class lettreCommande_factory {
	...
	public static function make() {
		...
		global $acquisition_pdfcde_print;
		$className = 'lettreCommande_PDF';
		if (file_exists("$base_path/acquisition/achats/commandes/$acquisition_pdfcde_print")) {
			require_once("$base_path/acquisition/achats/commandes/$acquisition_pdfcde_print");
			$className = basename($acquisition_pdfcde_print);	
		}
