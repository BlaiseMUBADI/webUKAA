...
// +-------------------------------------------------+
// $Id: oai_out_protocol.class.php,v 1.6.4.1 2012-02-16 10:32:08 jpermanne Exp $
...
class oai_out_get_records_notice extends oai_out_get_records {
	...
	public function get_record($rec_id, $format) {
		...
		$co_set->update_if_expired();
		$oai_cache = new external_services_converter_oairecord(1, $this->oai_cache_duration, $co_set->cache->cache_duration_in_seconds(), $this->source_set_ids, $this->repository_identifier, $this->notice_statut_deletion, $this->include_items);
...
class external_services_converter_oairecord extends external_services_converter {
	...
	function external_services_converter_oairecord($object_type, $life_duration, $set_life_duration, $source_set_ids, $repository_identifier, $deleted_record_statut, $include_items) {
