...
// +-------------------------------------------------+
// $Id: backup.class.php,v 1.1 2011-07-29 12:32:14 dgoron Exp $
	...
	function show_form ($param='') {
		...
		<div class='row'>
			...
			<div class='colonne_suite'>
				<select id='form_jeu_sauv' class='saisie-20em' name='form_jeu_sauv[]' size='".$size_select."' multiple>";
