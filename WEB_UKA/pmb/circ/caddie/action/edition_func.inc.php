...
// +-------------------------------------------------+
// $Id: edition_func.inc.php,v 1.4.6.1 2011-11-16 15:34:17 dgoron Exp $
				...
				for($i=0; $i < $nbr_lignes; $i++) {
					...
					if (!$p_perso->no_special_fields) {
						...
						for ($i=0; $i<count($perso_["FIELDS"]); $i++) {
							$p=$perso_["FIELDS"][$i];
							$worksheet->write_string($debligne_excel,($nbr_champs+2+$i),html_entity_decode($p["AFF"],ENT_QUOTES|ENT_COMPAT,"iso-8859-15"));
						}
					}
				}
				break;
