...
// +-------------------------------------------------+
// $Id: list_groups.inc.php,v 1.13.8.1 2012-02-28 15:40:59 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

// affichage de la liste des groupes pour sélection
function list_group($clef, $filter_list, $group_list, $nav_bar) {
...
if($nbr_lignes) {
	...
	if ((mysql_num_rows($res) > 1)||($page>1)) {
		...
		list_group($group_query, $filter_list, $group_list, $nav_bar);
	} else {
