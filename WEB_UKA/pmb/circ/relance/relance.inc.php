...
// +-------------------------------------------------+
// $Id: relance.inc.php,v 1.65.2.3 2012-04-12 07:28:57 dgoron Exp $
...
function send_mail($id_empr, $relance) {
	...
	$res_envoi=mailpmb($coords->empr_prenom." ".$coords->empr_nom, $coords->empr_mail,$objet." : ".$coords->empr_prenom." ".mb_strtoupper($coords->empr_nom,$charset)." (".$coords->empr_cb.")",$texte_mail,$biblio_name, $biblio_email,"Content-Type: text/plain; charset=\"$charset\"\n", "", $PMBuseremailbcc, 1);
	return $res_envoi;
}
...
if (($empr_sort_rows)||($empr_show_rows)||($empr_filter_rows)) {
	...
	$filter=new filter_list("empr","empr_list","b,n,c,cs,g","b,n,c,g".$localisation.",2,3,cs","n,g");
	if ($pmb_lecteurs_localises) {
