...
// +-------------------------------------------------+
// $Id: abts_pointage.class.php,v 1.42.2.2 2012-01-26 10:40:03 dgoron Exp $
...
ENDOFTEXT;
		...
		$form = str_replace("!!gestion_retard!!", $bt_gestion_retard, $form);
	...
	function delete_retard($abt_id,$date_parution='',$libelle_numero=''){		
