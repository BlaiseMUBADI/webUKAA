...
// +-------------------------------------------------+
// $Id: emprunteur.class.php,v 1.124.2.5 2012-01-26 13:50:08 dgoron Exp $
...
function do_fiche() {
	...
	//Si email emprunteur, alors on affiche le bouton de mail
	if ($this->mail) {
