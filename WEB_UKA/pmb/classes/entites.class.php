...
// +-------------------------------------------------+
// $Id: entites.class.php,v 1.37 2011-09-30 08:01:23 dgoron Exp $
...
class entites{
	...
	function getBibliHtmlSelect($user=FALSE, $selected=0, $sel_all=FALSE, $sel_attr=array()) {
	...
	function getRaisonSociale($tab=array(),$id_bibli=0) {
