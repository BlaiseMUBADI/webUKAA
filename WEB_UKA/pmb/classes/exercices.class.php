...
// +-------------------------------------------------+
// $Id: exercices.class.php,v 1.13 2011-06-06 08:04:27 dbellamy Exp $
...
//TODO Voir suppression du lien entre actes et exercices 
	...
	function getSessionExerciceId($id_bibli,$id_exer) {
		global $dbh;
	...
	function getHtmlSelect($id_bibli=0, $selected=0, $sel_all=FALSE, $sel_attr=array()) {
