...
// +-------------------------------------------------+
// $Id: expl_to_do.class.php,v 1.40.2.2 2012-01-12 10:01:58 dgoron Exp $
...
//	}
	...
	if ($this->expl->expl_comment) {
		...
		$expl_comment.=pmb_bidi("<div class='erreur'>${msg[expl_zone_comment]} :</div><div class='message_important'>".$this->expl->expl_comment."</div>");
	}
