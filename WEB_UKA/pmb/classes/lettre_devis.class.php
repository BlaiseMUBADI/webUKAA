...
// +-------------------------------------------------+
// $Id: lettre_devis.class.php,v 1.1.2.2 2012-02-13 16:18:20 dgoron Exp $
...
class lettreDevis_factory {
	...
	public static function make() {
		...
		global $acquisition_pdfdev_print;
		$className = 'lettreDevis_PDF';
		if (file_exists("$base_path/acquisition/achats/devis/$acquisition_pdfdev_print")) {
			require_once("$base_path/acquisition/achats/devis/$acquisition_pdfdev_print");
			$className = basename($acquisition_pdfdev_print);	
		}
