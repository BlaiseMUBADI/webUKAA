...
// +-------------------------------------------------+
// $Id: liens_actes.class.php,v 1.9 2011-06-06 08:04:26 dbellamy Exp $
...
class liens_actes{
	...
	function getOrder($num_acte_lie) {
	...
	function getChilds($num_acte, $type_acte=TYP_ACT_ALL) {
	...
	function getDeliveries ($num_cde, $with_date=false) {
