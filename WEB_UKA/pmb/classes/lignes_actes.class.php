...
// +-------------------------------------------------+
// $Id: lignes_actes.class.php,v 1.23 2011-08-11 15:39:30 dbellamy Exp $
...
class lignes_actes{
	...
	function getLines($tab_lig=array(), $relances=false) {
	...
	function getRelancesBySupplier ($id_fou=0) {
	...
	function setRelances ($tab_lig=array()) {
	...
	function deleteRelances($id_fou=0, $id_acte=0) {
