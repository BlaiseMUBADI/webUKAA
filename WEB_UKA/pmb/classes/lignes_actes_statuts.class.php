...
// +-------------------------------------------------+
// $Id: lignes_actes_statuts.class.php,v 1.1 2011-06-06 08:04:26 dbellamy Exp $
...
class lgstat{
	...
	function getHtmlSelect($selected=array(), $sel_all='', $sel_attr=array()) {
	...
	function existsLibelle($libelle,$id_statut) {
	...
	function delete($id_statut= 0) {
		
		global $dbh;

		if(!$id_statut) $id_statut = $this->id_statut; 	
