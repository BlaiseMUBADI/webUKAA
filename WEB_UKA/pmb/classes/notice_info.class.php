...
// +-------------------------------------------------+
// $Id: notice_info.class.php,v 1.23.2.1 2011-12-14 05:54:05 touraine37 Exp $
...
class notice_info {
	...
	function fetch_data() {
		...
		$requete = "select expl_id, expl_cb,expl_cote,expl_statut,statut_libelle, expl_typdoc, tdoc_libelle, expl_note, expl_comment, expl_section, section_libelle, expl_owner, lender_libelle, codestat_libelle, expl_date_retour, expl_date_depot, expl_note, pret_flag, location_libelle 
