...
// +-------------------------------------------------+
// $Id: receptions.class.php,v 1.3 2011-08-11 15:39:30 dbellamy Exp $
		...
		switch ($this->type_acte) {
			...
			case TYP_ACT_CDE :
				...
				if ($all_query=='') {
					...
					$q_cde.= "lignes_actes.code as code, libelle, lignes_actes.statut, commentaires_gestion, commentaires_opac, lignes_actes.num_produit as num_produit, num_acquisition ";
