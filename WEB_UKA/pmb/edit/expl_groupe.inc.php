...
// +-------------------------------------------------+
// $Id: expl_groupe.inc.php,v 1.33.6.1 2012-02-29 10:57:32 dgoron Exp $
...
$sql .= "WHERE pret.pret_idempr = empr.id_empr AND pret.pret_idexpl = exemplaires.expl_id AND empr_groupe.empr_id = empr.id_empr AND groupe.id_groupe = empr_groupe.groupe_id AND exemplaires.expl_typdoc = docs_type.idtyp_doc ";
$sql .= $critere_requete; 
