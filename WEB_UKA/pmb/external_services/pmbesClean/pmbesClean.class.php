...
// +-------------------------------------------------+
// $Id: pmbesClean.class.php,v 1.1 2011-07-29 12:32:14 dgoron Exp $
...
class pmbesClean extends external_services_api_class {
	...
	function indexNotices() {
		...
		if (SESSrights & ADMINISTRATION_AUTH) {
			...
			$query = mysql_query("SELECT notice_id,tparent_id,tit1,tit2,tit3,tit4,index_l, n_gen, n_contenu, n_resume, tnvol FROM notices");
			if(mysql_num_rows($query)) {		
