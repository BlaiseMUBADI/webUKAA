...
// +-------------------------------------------------+
// $Id: pmbesProcs.class.php,v 1.1 2011-07-29 12:32:11 dgoron Exp $
...
class pmbesProcs extends external_services_api_class {
	 ...
	 *  
	 */
	function executeProc($procedure, $idProc,$tparams, $limite_mysql='') {
...
//								mysql_query($sql, $dbh) or die(mysql_error());
			...
			//ne pas décommenter? plantage de l'API
//			if (preg_match_all("|!!(.*)!!|U",$hp->proc->requete,"")) {
//				$hp->get_final_query();
//				$code_sql=$hp->final_query;
//				$autorisations = $hp->proc->autorisations;
//			}
