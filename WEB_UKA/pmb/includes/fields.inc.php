...
// +-------------------------------------------------+
// $Id: fields.inc.php,v 1.15.6.1 2012-02-29 13:23:29 dgoron Exp $
...
function aff_selector($field,&$check_scripts) {
	...
	$ret.="<script>
		if (document.getElementById(\"$text_name\").form.name) {
			var form_name = document.getElementById(\"$text_name\").form.name;
			if (form_name == 'formulaire') {";
				$form_name="formulaire";
	$ret.="} else if (form_name == 'planificateur_form') {";
				$form_name="planificateur_form";
	$ret.="}
		}
		</script>";
	$ret.="<input class='bouton' value='...' onclick=\"window.open('./select.php?what=".$what."&dyn=&caller=".$form_name."&param1=".$hidden_name."&param2=".$text_name."&p1=".$hidden_name."&p2=".$text_name."&mode=un&deb_rech='+escape(''), 'select_author0', 'scrollbars=yes, toolbar=no, dependent=yes, width=400, height=400, resizable=yes')\" type='button'>";
