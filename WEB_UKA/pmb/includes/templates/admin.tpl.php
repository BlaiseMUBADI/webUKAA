...
// +-------------------------------------------------+
// $Id: admin.tpl.php,v 1.164.2.2 2012-04-02 14:25:57 dgoron Exp $
...
<ul>
	...
	".($pmb_opac_view_activate?"<li><a href='./admin.php?categ=opac&sub=opac_view'>".$msg["opac_view_admin_menu"]."</a></li>":"")."
</ul>
...
if($cms_active) $admin_menu_new.="
	<ul>
		<li><a href='./admin.php?categ=portail'>".$msg["cms_onglet_title"]."</a></li>
	</ul>";
