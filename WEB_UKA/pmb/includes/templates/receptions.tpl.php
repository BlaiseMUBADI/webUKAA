...
// +-------------------------------------------------+
// $Id: receptions.tpl.php,v 1.3 2011-08-11 15:39:30 dbellamy Exp $
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<div class='colonne3'>
				...
				<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=fournisseur&caller=recept_search_form&param1=f_fou_code0&param2=f_fou0&id_bibli='+this.form.id_bibli.value+'&deb_rech='+escape(this.form.f_fou0.value), 'select_fournisseur', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes'); \" />
			...
			<div class='colonne3'>
				...
				<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=origine&sub=empr&caller=recept_search_form&param1=f_dem_code0&param2=f_dem0&param3=t_dem0&deb_rech='+escape(this.form.f_dem0.value), 'select_user', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes'); \" />
			...
			<div class='colonne3'>
				...
				<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=rubriques&caller=recept_search_form&param1=f_rub_code0&param2=f_rub0&id_bibli='+this.form.id_bibli.value+'&id_exer='+this.form.id_exer.value+'&deb_rech='+escape(this.form.f_rub0.value), 'select_user', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes'); \" />
...
<div class='row'>
	...
	<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=fournisseur&caller=recept_search_form&param1=f_fou_code!!i!!&param2=f_fou!!i!!&id_bibli='+this.form.id_bibli.value+'&deb_rech='+escape(this.form.f_fou!!i!!.value), 'select_user', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes'); \" />
</div>
";
...
<div class='row'>
	...
	<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=origine&sub=empr&caller=recept_search_form&param1=f_dem_code!!i!!&param2=f_dem!!i!!&param3=t_dem0&deb_rech='+escape(this.form.f_dem0.value), 'select_user', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes'); \" />
</div>
";
...
<div class='row'>
	...
	<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=rubriques&caller=recept_search_form&param1=f_rub_code!!i!!&param2=f_rub!!i!!&param3=t_rub0&deb_rech='+escape(this.form.f_rub!!i!!.value), 'select_user', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes'); \" />
</div>
";
