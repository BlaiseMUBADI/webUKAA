...
// +-------------------------------------------------+
// $Id: receptions_frame.tpl.php,v 1.6 2011-08-10 10:08:27 dbellamy Exp $
...
$recept_deliv_form_expl = "
		...
		<div class='row'>
			<div class='right'>
				<input type='button' class='bouton_small' value='".htmlentities($msg['acquisition_recept_explnum_add'],ENT_QUOTES, $charset)."' onclick='recept_add_expl(this.form);' />
			</div>
		</div>
		<br />
";		
