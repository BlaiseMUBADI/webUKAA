...
// +-------------------------------------------------+
// $Id: taches.tpl.php,v 1.1 2011-07-29 12:32:08 dgoron Exp $
...
$planificateur_form="
!!script_js!!
<form name='planificateur_form' action='$base_path/admin.php?categ=planificateur&sub=manager&act=task&type_task_id=!!type_task_id!!&planificateur_id=!!planificateur_id!!' method='post' onSubmit='!!submit_action!!' class='form-$current_module' enctype='multipart/form-data'>
	<h3>".$msg["planificateur_task_type_task"]." : !!libelle_type_task!!</h3>
	<div class='form-contenu'>
		<div class='row'>
			<div class='colonne3'><label for='name'/>".$msg["planificateur_task_name"]."</label></div><div class='colonne_suite'><input type='text' name='task_name' id='task_name' value='!!task_name!!' maxlength='30' class='saisie-20em'/></div>
		</div>
		<div class='row'>
		<div class='row'>
			<div class='colonne3'><label for='desc'/>".$msg["planificateur_task_desc"]."</label></div><div class='colonne_suite'><textarea name='task_desc' id='task_desc' class='saisie-30em'/>!!task_desc!!</textarea></div>
		</div>
		<div class='row'>
			<div class='colonne3'><label for='users'/>".$msg["planificateur_task_users"]."</label></div><div class='colonne_suite'>!!task_users!!</div>
		</div>
		<div class='row'>
			<div class='colonne3'><label for='activate'/>".$msg["planificateur_task_active"]."</label></div><div class='colonne_suite'>!!task_statut!!</div>
		</div>
		!!div_upload!!
		<div class='row'>
			&nbsp;
	...
	<input type='button' value='".$msg["76"]."' class='bouton' onClick='history.go(-1);'/>&nbsp;<input type='submit' name='save_task' value='".$msg["77"]."' class='bouton' /><div class='right'>!!bt_supprimer!!</div>
	</div>
</form>
