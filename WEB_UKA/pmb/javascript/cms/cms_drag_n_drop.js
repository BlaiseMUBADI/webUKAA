...
// +-------------------------------------------------+
// $Id: cms_drag_n_drop.js,v 1.1 2011-09-28 14:24:31 ngantier Exp $
...
function cms_mouse_down_draggable(e) {
	...
	console.log("Position absolue initiale du draggé ",pos_init_absolute[0],pos_init_absolute[1]);
...
function cms_create_dragged(targ) {
	...
	if (current_drag==null) {
		...
		current_drag.style.border="1px dashed red";
