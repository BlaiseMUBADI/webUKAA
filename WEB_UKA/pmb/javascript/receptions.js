...
// +-------------------------------------------------+
// $Id: receptions.js,v 1.2 2011-06-22 18:14:36 dbellamy Exp $
...
function sel_fou() {
    ...
    openPopUp('./select.php?what=fournisseur&caller=recept_search_form&param1='+name_id+'&param2='+name+'&id_bibli='+id_bibli+'&deb_rech='+escape(deb_rech), 'select_fournisseur', 500, 400, -2, -2, '');
}
...
function sel_dem() {
    ...
    var deb_rech = document.getElementById(name).value;
    openPopUp('./select.php?what=origine&sub=empr&caller=recept_search_form&param1='+name_id+'&param2='+name+'&param3='+name_type+'&deb_rech='+escape(deb_rech), 'select_user', 500, 400, -2, -2, '');
}
...
function sel_rub() {
    ...
    var deb_rech = document.getElementById(name).value;
    openPopUp('./select.php?what=rubriques&caller=recept_search_form&param1='+name_id+'&param2='+name+'&id_bibli='+id_bibli+'&id_exer='+id_exer+'&deb_rech='+escape(deb_rech), 'select_user', 500, 400, -2, -2, '');
}
