...
// +-------------------------------------------------+
// $Id: ajax_selector.php,v 1.24.2.3 2012-03-14 08:49:50 jpermanne Exp $
...
switch ($origine):
	case 'SQL':
		...
		if (mysql_num_rows($resultat) > 0) {
			...
			echo "<div id='l".$id."_0' style='cursor:default;font-family:arial,helvetica;font-size:10px;width:100%'>".$msg["no_result"]."</div>";
		}
		break;
	case 'TABLEAU':
	...
	case 'ARRAY':
		if (count($array_selector) > 0) {
			...
			echo "<div id='l".$id."_0' style='cursor:default;font-family:arial,helvetica;font-size:10px;width:100%;color:red;'>".$msg["no_result"]."</div>";
		}
		break;
	default: 
		break;
