...
// +-------------------------------------------------+
// $Id: collstate.class.php,v 1.9.2.3 2012-01-18 16:44:02 dgoron Exp $
...
function get_display_list($base_url,$filtre,$debut=0,$page=0, $type=0) {
	...
	if($opac_view_filter_class){		
		$req="SELECT  collstate_id , location_id, num_infopage, surloc_id FROM arch_statut, collections_state 
			LEFT JOIN arch_emplacement ON collstate_emplacement=archempla_id, docs_location, sur_location 
			...
			and docs_location.surloc_num=surloc_id and archstatut_id=collstate_statut 
	...
	if(($this->nbr = mysql_num_rows($myQuery))) {
