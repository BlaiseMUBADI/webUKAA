...
// +-------------------------------------------------+
// $Id: notice_affichage.class.php,v 1.299.2.10 2012-03-28 12:10:47 dgoron Exp $
...
class notice_affichage {
	...
	function genere_ajax($aj_type_aff,$header_only_origine=0){
		...
		$param['function_to_call']="aff_notice";  	
  		...
  		$param['aj_nodocnum']=$this->docnum_allowed;
		...
		$template="
			<div id=\"el!!id!!Parent\" class=\"notice-parent\">
			$case_a_cocher
	    	<img class='img_plus' src=\"".$opac_url_base."images/plus.gif\" name=\"imEx\" id=\"el!!id!!Img\" title=\"".$msg["expandable_notice"]."\" border=\"0\" param='".rawurlencode($this->notice_affichage_cmd)."' onClick=\"expandBase_ajax('el!!id!!', true,this.getAttribute('param')); return false;\" hspace=\"3\"/>";
		if ($icon) {
    		$info_bulle_icon=str_replace("!!niveau_biblio!!",$biblio_doc[$this->notice->niveau_biblio],$msg["info_bulle_icon"]);
    		$info_bulle_icon=str_replace("!!typdoc!!",$tdoc->table[$this->notice->typdoc],$info_bulle_icon);    			
    		$template.="<img src=\"".$opac_url_base."images/$icon\" alt='".$info_bulle_icon."' title='".$info_bulle_icon."'/>";
	...
	function do_header_without_html() {
		global $opac_notice_reduit_format ;
		global $msg ;
