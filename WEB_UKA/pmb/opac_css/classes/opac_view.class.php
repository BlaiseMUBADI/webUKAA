...
class opac_view {
	...
	var $param_subst; //Classe d'écrasement des paramètres substitués pour cette vue
	var $opac_filters; //Filtres des éléments de l'OPAC
	var $view_list_empr_default; //Identifiant de la vue par défaut pour l'utilisateur courant
	var $opac_views_list; //Tableau des vues visibles en OPAC (opac_view_visible=1)
	var $selector; //Liste de sélection des vues visibles en OPAC (opac_view_visible=1)
	var $search_class;
