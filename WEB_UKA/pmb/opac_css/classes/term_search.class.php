...
// +-------------------------------------------------+
// $Id: term_search.class.php,v 1.24 2009-05-16 10:52:42 dbellamy Exp $
//
...
class term_search {
    ...
    function term_search($search_term_name,$search_term_origin_name,$n_per_page=200,$base_query,$url_for_term_show,$url_for_term_search,$keep_tilde=0,$id_thes=0) {
    	...
    	$this->search_term=stripslashes(stripslashes($$search_term_name));
    ...
    function page_navigator() {
    	...
    	if ($this->offset!=0) $navig.="<a href=\"$url_page&page=0\"><img src='./images/first.gif' border='0'/></a>"; else $navig.="<img src='./images/first-grey.gif' border='0'/>";
		if ($this->offset!=0) $navig.="<a href=\"$url_page&page=".($this->page-1)."&".$this->base_query."\"><img src='./images/prev.gif' border='0'/></a>"; else $navig.="<img src='./images/prev-grey.gif' border='0'/>";
		$navig.=" (".($this->offset+1)."-".min($this->offset+$this->n_per_page,$this->n_total).")/".$this->n_total." ";
		if (($this->offset+$this->n_per_page+1)<$this->n_total) $navig.="<a href=\"$url_page&page=".($this->page+1)."&".$this->base_query."\"><img src='./images/next.gif' border='0'/></a>"; else $navig.="<img src='./images/next-grey.gif' border=0/>";
		if (($this->offset+$this->n_per_page+1)<$this->n_total) $navig.="<a href=\"$url_page&page=$last_page\"><img src='./images/last.gif' border='0'/></a>"; else $navig.="<img src='./images/last-grey.gif' border='0'/>";
		return $navig;	
    }
