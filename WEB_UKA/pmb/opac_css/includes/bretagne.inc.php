...
// +-------------------------------------------------+
// $Id: bretagne.inc.php,v 1.3.10.5 2012-01-17 17:38:38 dbellamy Exp $
...
function search_other_function_clause(&$clause) {
	...
	$r="";
	if ($section) {
		$r.=$clause." join notices_custom_values as e0 on e0.notices_custom_origine=notice_id and notices_custom_integer in (".$section.") and notices_custom_champ=6 ";
	}
	if ($r=="") $r=$clause;
