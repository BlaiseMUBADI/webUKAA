...
// +-------------------------------------------------+
// $Id: index_includes.inc.php,v 1.47.2.5 2012-03-20 14:54:37 dgoron Exp $
...
if ($opac_show_bandeaugauche==0) {
	...
	print str_replace("!!contenu_bandeau!!",$home_on_left.$loginform.$meteo.$facette.$adresse,$footer);
} 
