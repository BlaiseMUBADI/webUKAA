...
// +-------------------------------------------------+
// $Id: notice_tpl.inc.php,v 1.15.2.2 2012-01-15 07:59:58 touraine37 Exp $
...
function aff_expl($param) {
	...
	for ($i = 0 ; $i < count($notice["notice_info"]->memo_exemplaires) ; $i++) {
		$res.="<tr>";
		$res.="<td>".$notice["notice_info"]->memo_exemplaires->tdoc_libelle."</td>";
		$res.="<td>".$notice["notice_info"]->memo_exemplaires->location_libelle."</td>";
		$res.="<td>".$notice["notice_info"]->memo_exemplaires->section_libelle."</td>";
		$res.="<td>".$notice["notice_info"]->memo_exemplaires->expl_cote."</td>";
		$res.="<td>".$notice["notice_info"]->memo_exemplaires->expl_cb."</td>";
		$res.="<td>".$notice["notice_info"]->memo_exemplaires->statut_libelle."</td>";
		$res.="</tr>";
	}
	$res.="</table>";
	return $res;
