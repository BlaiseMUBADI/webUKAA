...
// +-------------------------------------------------+
// $Id: publisher_see.inc.php,v 1.45 2011-10-07 07:41:15 ngantier Exp $
...
if($id) {
	...
	if($nbr_lignes) {
		...
		print "<hr /><center>".printnavbar($page, $nbepages, "./index.php?lvl=publisher_see&id=$id&page=!!page!!&nbr_lignes=$nbr_lignes&l_typdoc=".rawurlencode($l_typdoc))."</center>\n";
	} else {
