...
class external_sources {
	var $id;
	var $n_ligne;		//Numï¿½ro de ligne du critï¿½re dans la multi-critï¿½re
	var $params;		//
    ...
    //fonction de rï¿½cupï¿½ration des opï¿½rateurs disponibles pour ce champ spï¿½cial (renvoie un tableau d'opï¿½rateurs)
    function get_op() {
    	$operators = array();
    	$operators["EQ"]="=";
    	return $operators;
    ...
    //fonction de crï¿½ation de la requï¿½te (retourne une table temporaire)
    function make_search() {	
    	global $search;
    	global $selected_sources;

    	//On modifie l'opï¿½rateur suivant !!
    ...
    //fonction de traduction littï¿½rale de la requï¿½te effectuï¿½e (renvoie un tableau des termes saisis)
