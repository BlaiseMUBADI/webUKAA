...
// +-------------------------------------------------+
// $Id: show_cart.inc.php,v 1.38.2.3 2012-02-21 16:02:02 dbellamy Exp $
...
if (count($cart_)) {
	...
	print "<input type='button' id='show_cart_empty' class='bouton' value=\"".$msg["show_cart_empty"]."\" title=\"".$msg["show_cart_empty_title"]."\" onClick=\"document.location='./index.php?lvl=show_cart&raz_cart=1'\" />&nbsp;
