...
// +-------------------------------------------------+
// $Id: subcoll_see.inc.php,v 1.43 2011-10-07 07:42:22 ngantier Exp $
...
if($id) {
	...
	if(!$nbr_lignes) {
		...
		if($nbr_lignes) {
			...
			print "<hr /><center>".printnavbar($page, $nbepages, "./index.php?lvl=subcoll_see&id=$id&page=!!page!!&nbr_lignes=$nbr_lignes&l_typdoc=".rawurlencode($l_typdoc))."</center>\n";
