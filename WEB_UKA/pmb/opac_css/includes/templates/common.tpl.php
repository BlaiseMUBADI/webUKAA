...
// +-------------------------------------------------+
// $Id: common.tpl.php,v 1.144.2.2 2012-01-24 16:34:20 dgoron Exp $
...
if($opac_recherche_ajax_mode){
	$begin_result_liste = "<a href='javascript:expandAll_ajax(".$opac_recherche_ajax_mode.")'><img class='img_plusplus' src='./images/expand_all.gif' border='0' id='expandall'></a>&nbsp;<a href='javascript:collapseAll()'><img class='img_moinsmoins' src='./images/collapse_all.gif' border='0' id='collapseall'></a>" ;
}else{
...
$affich_tris_result_liste= "&nbsp;<a href='index.php?lvl=sort&page_en_cours=!!page_en_cours!!' alt=\"".$msg['tris_dispos']."\" title=\"".$msg['tris_dispos']."\"><img src='./images/orderby_az.gif' align='bottom' hspace='3' border='0' id='sort_icon'></a>";
