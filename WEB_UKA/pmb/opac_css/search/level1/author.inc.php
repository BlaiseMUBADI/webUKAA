...
// +-------------------------------------------------+
// $Id: author.inc.php,v 1.33.2.6 2012-02-21 13:13:44 dgoron Exp $
...
if($opac_allow_affiliate_search){
	...
	print "
		...
		<script>
			...
			author_search.request('./ajax.php?module=ajax&categ=search',true,'&search_type=authorities&type=author&user_query=$user_query',true,authorResults);
