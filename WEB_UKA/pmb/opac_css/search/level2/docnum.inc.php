...
// +-------------------------------------------------+
// $Id: docnum.inc.php,v 1.9 2011-10-11 10:16:58 arenou Exp $
...
$requete = "select explnum_id, uni.notice_id,explnum_mimetype, pert from ($requete_noti UNION $requete_bull) as uni join notices n on uni.notice_id=n.notice_id" ; 
