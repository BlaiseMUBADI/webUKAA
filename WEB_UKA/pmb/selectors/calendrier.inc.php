...
// +-------------------------------------------------+
// $Id: calendrier.inc.php,v 1.16.8.1 2011-12-28 10:05:08 dgoron Exp $
...
$base_url = "./select.php?what=calendrier&caller=$caller&date_caller=$date_caller&param1=$param1&param2=$param2&after=$after&auto_submit=$auto_submit&date_anterieure=$date_anterieure&func_to_call=$func_to_call&id=$id&sub_param1=$sub_param1";
...
if($act == "calc_date"){
	...
	echo "<div class='row'>";
	echo calendar($date);	
	$form_action ="./select.php?what=calendrier&caller=$caller&date_caller=$date_caller&param1=$param1&param2=$param2&after=$after&date_anterieure=$date_anterieure&auto_submit=$auto_submit&func_to_call=$func_to_call&id=$id&sub_param1=$sub_param1";
