...
-- 2011-Nov-18 16:38:53
-- $Id: bibli.sql,v 1.68.4.1 2011-11-18 15:42:19 touraine37 Exp $
set names 'utf8';
...
CREATE TABLE notices_fields_global_index (
  ...
  KEY i_value (value(1000)),
  KEY i_id_value (id_notice,value(300))
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE notices_mots_global_index (
  ...
  lang varchar(10) NOT NULL DEFAULT '',
  PRIMARY KEY (id_notice,code_champ,code_ss_champ,mot),
  KEY code_champ (code_champ),
  KEY mot (mot),
  KEY i_mot (mot),
  KEY i_id_mot (id_notice,mot)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE users (
  ...
  explr_invisible text,
  explr_visible_mod text,
  explr_visible_unmod text,
