...
-- +-------------------------------------------------+
-- $Id: readme.txt,v 1.6 2006-10-31 12:18:38 touraine37 Exp $


Description des fichiers
bibli.sql : structure de la base de données uniquement, pas de données
		*************************************
		Méthode de céation de ce fichier : attention, PB avec --compatible=mysql40 qui supprime les autoincrements
				créer le contenu du fichier bibli.sql : mysqldump -u bibli -pbibli -d --compatible=mysql40 --create-options --quote-names=FALSE --skip-opt bibli > create_tables.sql
				copier/coller le contenu de ce fichier dans bibli.sql en enlevant en début et fin de fichier :
				...
				Exécuter (en ligne de commande) le script 
					php -q alter_bibli.sql.auto_increment.php
					afin de créer le fichier alter_bibli.sql
				Ajouter le contenu de alter_bibli.sql à la fin de bibli.sql
				Effacer le fichier alter_bibli.sql
		*************************************
